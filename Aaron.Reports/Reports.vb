...
#Region "       As PDF		>>>"
	...
	Shared Sub AddPage(Resize As Boolean, ImagePath As String, ByRef oPdfDoc As iTextSharp.text.Document, oPdfWriter As iTextSharp.text.pdf.PdfWriter)
		Dim oImage As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance(ImagePath)
