...
#Region "       Utilities	>>>"
		...
		''' <stepthrough></stepthrough>
		<DebuggerNonUserCode()>
		Overridable Function AsStream(Report As CodeReason.Reports.ReportDocument, Page As Integer, Quality As Single) As IO.MemoryStream
...
#End Region
		...
		'Dim Att$ = "<FlowDocument" & C1 & T1 _
		'		   & "xmlns = ""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x = ""http://schemas.microsoft.com/winfx/2006/xaml"" " & C1 & T1 _
		'		   & "xmlns:xrd = ""clr-namespace:CodeReason.Reports.Document;assembly=CodeReason.Reports"" " & C1 & T1 _
		'		   & "xmlns:crcv = ""clr-namespace:CodeReason.Reports.Charts.Visifire;assembly=CodeReason.Reports.Charts.Visifire"" " & C1 & T1 _
		'		   & "PageHeight=""29.7cm"" PageWidth=""21cm"" ColumnWidth=""21cm"">" & C1

		'Builder.Replace("<FlowDocument>", Att)

		''Added Extra Code to keep this working 
		'Builder.Replace("xrd:ReportProperties", "ReportProperties")
		'Builder.Replace("xrd:SectionReport", "SectionReport")
		'Builder.Replace("xrd:InlineContextValue", "InlineContextValue")
		'Builder.Replace("xrd:InlineDocumentValue", "InlineDocumentValue")
		'Builder.Replace("<Style x:Key", "<Style Key")
		'Builder.Replace("xrd:SectionDataGroup", "SectionDataGroup")
		'Builder.Replace("xrd:TableRowFor", "TableRowFor")
